...
::grpc::Status MessageService::Stub::Calculate(::grpc::ClientContext* context, const ::MessageRequest& request, ::OperationResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Calculate_, context, request, response);
}

void MessageService::Stub::experimental_async::Calculate(::grpc::ClientContext* context, const ::MessageRequest* request, ::OperationResponse* response, std::function<void(::grpc::Status)> f) {
...
void MessageService::Stub::experimental_async::Calculate(::grpc::ClientContext* context, const ::MessageRequest* request, ::OperationResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::OperationResponse>* MessageService::Stub::AsyncCalculateRaw(::grpc::ClientContext* context, const ::MessageRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::OperationResponse>* MessageService::Stub::PrepareAsyncCalculateRaw(::grpc::ClientContext* context, const ::MessageRequest& request, ::grpc::CompletionQueue* cq) {
...
MessageService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< MessageService::Service, ::MessageRequest, ::OperationResponse>(
...
::grpc::Status MessageService::Service::Calculate(::grpc::ServerContext* context, const ::MessageRequest* request, ::OperationResponse* response) {
  (void) context;
  (void) request;
  (void) response;
