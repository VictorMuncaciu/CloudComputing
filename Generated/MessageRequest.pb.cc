...
static void InitDefaultsscc_info_MessageRequest_MessageRequest_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MessageRequest_MessageRequest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MessageRequest_MessageRequest_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_MessageRequest_2eproto_sccs[1] = {
  &scc_info_MessageRequest_MessageRequest_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MessageRequest_2eproto = {
  &descriptor_table_MessageRequest_2eproto_initialized, descriptor_table_protodef_MessageRequest_2eproto, "MessageRequest.proto", 79,
...
void MessageRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_MessageRequest_MessageRequest_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "MessageRequest.Message"));
          CHK_(ptr);
...
template<> PROTOBUF_NOINLINE ::MessageRequest* Arena::CreateMaybeMessage< ::MessageRequest >(Arena* arena) {
  return Arena::CreateInternal< ::MessageRequest >(arena);
}
