...
set GRPC_PATH=D:\faculte\LabCNA\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=D:\faculte\LabCNA\vcpkg-master\installed\x86-windows\tools\protobuf
